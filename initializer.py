...
class Initializer():
    ...
    def pSMAC_wrapper_generator(self,wrapper,maximize):
        '''
        ...
        writeToFile.append('{}({}, "{}",{},{})'.format(wrapper,self.nThreadMinizinc, self.cplex_dll,maximize, self.obj_mode))
